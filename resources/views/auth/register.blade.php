<x-guest-layout>
    <p class="text-center size-8 text-[#051AFF] font-medium">Регистрация</p>
...
<form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="login" class="block mt-1 w-full" type="text" name="login" :value="old('name')" required autofocus autocomplete="login" />
